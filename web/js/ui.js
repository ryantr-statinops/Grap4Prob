...
export class UIController {
    ...
    exportChartPng() {
        this.chartManager.exportChartPng();
    }
    ...
    // ===== Theme (delegated to ChartManager) =====
    getThemeColors() {
        return this.chartManager.getThemeColors();
    }
    ...
    // ===== Chart (delegated to ChartManager) =====
    renderChart(results) {
        this.chartManager.renderChart(results);
    }

    // ===== Convergence Chart (delegated to ChartManager) =====
    renderConvergenceChart(history, theoreticalProb) {
        this.chartManager.renderConvergenceChart(history, theoreticalProb);
    }
